    ...
    <div>
      ...
      <Form onFinish={onFinish}>
        ...
        <Form.Item className="item-btnModal" wrapperCol={8}>
          <Button className="btnFormModal" type="primary" htmlType="submit">
            Login
          </Button>
        </Form.Item>
      </Form>
      ...
      <Space size={10} className="space-btn" style={{ paddingBottom: 35 }}>
        <Button
          className="btn-signin"
          style={{ background: "#3C589C" }}
          icon={<FaFacebookF className="fbicon" />}
        >
          FACEBOOK
        </Button>
        <Button
          className="btn-signin"
          style={{ background: "#DF4B3B" }}
